...
class TestAccountRepositoryAllMethods:
    ...
    async def test_create_returns_account_model(self):
        repo = AccountRepository()
        raw = {"id": 1, "login": "alice", "password": "hashed", "is_blocked": False}
    ...
    @pytest.mark.parametrize("account_id,raw,should_raise", [
        (1, {"id": 1, "login": "bob", "password": "h", "is_blocked": False}, False),
        (2, None, True),
    ])
    ...
    @pytest.mark.parametrize("account_id,raw,should_raise", [
        (1, {"id": 1, "login": "carol", "password": "h", "is_blocked": False}, False),
        (2, None, True),
    ])
    ...
    @pytest.mark.parametrize("account_id,raw,should_raise", [
        (1, {"id": 1, "login": "dave", "password": "h", "is_blocked": True}, False),
        (2, None, True),
    ])
    ...
    @pytest.mark.parametrize("login,password,raw,should_raise", [
        ("eve", "correct", {"id": 3, "login": "eve", "password": "h", "is_blocked": False}, False),
        ("eve", "wrong",   None, True),
    ])
